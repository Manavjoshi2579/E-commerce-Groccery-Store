...
const routePermissions: Record<string, RoleName[]> = {
  products: [RoleName.SUPER_ADMIN, RoleName.STORE_MANAGER],
  ...
  coupons: [RoleName.SUPER_ADMIN, RoleName.STORE_MANAGER],
  reports: [RoleName.SUPER_ADMIN, RoleName.STORE_MANAGER, RoleName.BILLING_STAFF],
